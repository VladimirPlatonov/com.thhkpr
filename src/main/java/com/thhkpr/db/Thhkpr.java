...
public class Thhkpr extends SchemaImpl {
    ...
    private static final long serialVersionUID = -879891611;
     ...
     */
    public final Settings SETTINGS = com.thhkpr.db.tables.Settings.SETTINGS;

    /**
     * The table <code>thhkpr.storage</code>.
     */
    public final Storage STORAGE = com.thhkpr.db.tables.Storage.STORAGE;

    /**
     * The table <code>thhkpr.things</code>.
     */
    public final Things THINGS = com.thhkpr.db.tables.Things.THINGS;

    /**
     * The table <code>thhkpr.users</code>.
     */
    public final Users USERS = com.thhkpr.db.tables.Users.USERS;
